...
ath.intl = {
	...
	pt_pt: {
		message: 'Para adicionar esta web app ao ecrã principal: clique %icon e selecione <strong>%action</strong>.',
		action: { ios: 'Adicionar ao ecrã principal', android: 'Adicionar ao ecrã principal', windows: 'Adicionar ao inicio' }
	},
